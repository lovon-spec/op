...
The ISOCHRON uses a rotating proposer model where proposers take turns producing blocks across all connected chains. Each proposer MUST:
...
> Violations are removable via the arbitrator (Kleros default).
