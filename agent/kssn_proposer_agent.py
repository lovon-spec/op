#!/usr/bin/env python3
"""
ISOCHRON Proposer Agent for the Interconnected Sequencing Oracle (default arbitrator: Kleros Court)
...
def main():
    parser = argparse.ArgumentParser(
        description="ISOCHRON Proposer Agent for Interconnected Sequencing Oracle (Kleros default arbitrator)"
    )
    parser.add_argument(
        "--config", "-c",
        required=True,
