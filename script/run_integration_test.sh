...
echo "or sustained downtime).  An arbitrator jury (default Kleros Court) ruled against them."
echo ""
...
echo "and passed the arbitrator-backed curation challenge period (default Kleros Curate)."
echo ""
