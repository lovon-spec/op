#!/bin/bash
# Full OP Stack L2 Integration Test with ISOCHRON Sequencer Rotation (Kleros default)
#
# This script runs a complete integration test showing:
# 1. L1 (Anvil) with SequencerManager (Kleros default) controlling SystemConfig
...
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║                                                                ║"
echo "║   SEQUENCER MANAGER (KLEROS DEFAULT) - OP STACK INTEGRATION    ║"
echo "║                                                                ║"
...
echo -e "  ${GREEN}✓${NC} SequencerManager (Kleros default): $MANAGER"
...
echo -e "  Challenge submitted to default TCR (Kleros Curate today)"
