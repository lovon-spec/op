...
# ═══════════════════════════════════════════════════════════════════════════════
#
# This script tests the integration between the ISOCHRON sequencer manager
# (legacy: KlerosSequencerManager) and the OP Stack architecture. It verifies how the
# arbitrator-governed rotation system (default: Kleros) controls which sequencer/batcher is authorized
...
# - Sequencer manager (legacy: KlerosSequencerManager): Controls batcherHash in SystemConfig
...
# - The sequencer manager would own SystemConfig and rotate sequencers
...
echo "  - Arbitrator-governed rotation between sequencers (default: Kleros)"
...
print_step "Deploying MockCurate, MockSystemConfig, and the sequencer manager (legacy: KlerosSequencerManager)..."
...
print_info "SequencerManager (legacy: KlerosSequencerManager): $MANAGER"
...
print_warning "Evidence submitted to arbitrator TCR (default: Kleros)"
...
echo "L1 Contracts:"
echo "  - MockCurate (arbitrator TCR, default: Kleros): $CURATE"
...
echo ""
echo "This test verifies how the sequencer manager (legacy: KlerosSequencerManager) integrates with OP Stack:"
