...
class L2Simulator:
    ...
    def get_current_sequencer(self) -> str:
        """Get current sequencer from the sequencer manager (legacy: KlerosSequencerManager)"""
...
def main():
    ...
    parser.add_argument("--manager", required=True, help="Sequencer manager address (legacy: KlerosSequencerManager)")
