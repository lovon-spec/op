#!/bin/bash
#
# Full OP Stack Devnet with ISOCHRON Sequencer Manager (legacy: KlerosSequencerManager)
#
# This script runs a complete OP Stack devnet:
# - L1: Anvil
# - L2: op-geth + op-node
# - Batcher: op-batcher (3 instances for rotation testing)
# - Sequencer control: ISOCHRONSequencerManager (legacy: KlerosSequencerManager)
#
...
echo "  Deploying SequencerManager (legacy: KlerosSequencerManager) and mocks..."
...
echo "Testing sequencer rotation via the sequencer manager (legacy: KlerosSequencerManager)..."
echo ""
