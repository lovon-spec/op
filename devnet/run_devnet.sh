#!/bin/bash
#
# Full OP Stack Devnet with ISOCHRON Sequencer Manager
#
# This script runs a complete OP Stack devnet:
# - L1: Anvil
# - L2: op-geth + op-node
# - Batcher: op-batcher (3 instances for rotation testing)
# - Sequencer control: SequencerManager (legacy contract)
#
...
echo "  Deploying SequencerManager and mocks..."
...
echo "  SequencerManager (legacy): $MANAGER"
echo ""
...
echo "Testing sequencer rotation via SequencerManager..."
echo ""
