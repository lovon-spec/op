...
| Parameter | Value |
|-----------|-------|
| Arbitrator | External arbitration court |
| Court ID | 4 (Blockchain Technical) |
| Number of Jurors | 3 (initial round) |
| Appeal Rounds | Standard arbitration appeal process |
...
1. Dispute is created in the arbitration court (Blockchain Technical)
2. Three jurors are drawn for initial round
3. Both parties present evidence
4. Jurors vote based on this policy
5. Standard arbitration appeal process applies
...
2. **Subsequent Appeals**: Follow standard arbitration escalation
