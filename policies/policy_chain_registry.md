...
| Parameter | Value |
|-----------|-------|
| Arbitrator | Configurable (default: Kleros Court) |
| Court ID | Default: 4 (Blockchain Technical) |
| Number of Jurors | 3 (initial round, configurable) |
| Appeal Rounds | Standard arbitrator appeal process (default Kleros) |
...
1. Dispute is created in the configured arbitrator (default Kleros Court, Blockchain Technical)
2. Three jurors are drawn for initial round
3. Both parties present evidence
4. Jurors vote based on this policy
5. Standard arbitrator appeal process applies (default Kleros)
...
2. **Subsequent Appeals**: Follow standard arbitrator escalation (default Kleros)
