 ...
 *      - Disputes are resolved via the arbitrator (Kleros is the default today)
...
contract ChainRegistry is IChainRegistry, IArbitrable, IEvidence {
    ...
    /// @notice The arbitrator contract (Kleros is the default today)
     ...
     * @param _arbitrator The arbitrator contract (Kleros is the default today)
