 ...
 * @dev This registry allows L2 chains to apply for integration into ISOCHRON.
 ...
 *
 *      Acceptance Criteria (enforced via the arbitrator, defaulting to Kleros):
...
interface IChainRegistry {
     ...
     * @param disputeID The arbitrator dispute ID (if disputed)
