...
print_header() {
    echo ""
    echo -e "${CYAN}================================================================${NC}"
    echo -e "${CYAN}  ISOCHRON - OP Stack with arbitration governance${NC}"
    echo -e "${CYAN}================================================================${NC}"
    echo ""
}
...
deploy_remote() {
    ...
    echo "  Arbitration Court: $KLEROS_COURT"
    echo "  WETH:         $WETH"
    ...
    if [ "$PRODUCTION" != "true" ]; then
        ...
        echo "Production mode: Register operators through the arbitration registry."
